...
Apple/OCI image:    ghcr.io/luohao830/sub2api-plus:v0.2.0-custom.002
```
...
docker build \
  ...
  --tag ghcr.io/luohao830/sub2api-plus:v0.2.0-custom.002 \
  .
```

After that image is available to the Apple `container` runtime, set
`APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/luohao830/sub2api-plus:v0.2.0-custom.002`. Until then, keep
