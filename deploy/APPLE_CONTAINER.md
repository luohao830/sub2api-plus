...
Apple/OCI image:    ghcr.io/luohao830/sub2api-plus:v0.1.183-custom.005
```
...
docker build \
  ...
  --tag ghcr.io/luohao830/sub2api-plus:v0.1.183-custom.005 \
  .
```

After that image is available to the Apple `container` runtime, set
`APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/luohao830/sub2api-plus:v0.1.183-custom.005`. Until then, keep
