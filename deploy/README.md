...
curl -sSL https://raw.githubusercontent.com/luohao830/sub2api-plus/main/deploy/docker-deploy.sh | bash

# Or download first, then run
curl -sSL https://raw.githubusercontent.com/luohao830/sub2api-plus/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
```bash
# Clone repository
git clone https://github.com/luohao830/sub2api-plus.git
...
```bash
curl -sSL https://raw.githubusercontent.com/luohao830/sub2api-plus/main/deploy/install.sh | sudo bash
```

### Manual Installation

1. Download the latest release from [GitHub Releases](https://github.com/luohao830/sub2api-plus/releases)
...
```bash
curl -sSL https://raw.githubusercontent.com/luohao830/sub2api-plus/main/deploy/install.sh | bash -s -- list-versions
```
...
```bash
curl -sSL https://raw.githubusercontent.com/luohao830/sub2api-plus/main/deploy/install.sh | sudo bash -s -- install --version 'v0.1.183+custom.004'
```

Roll back an existing binary installation to an earlier published version:

```bash
curl -sSL https://raw.githubusercontent.com/luohao830/sub2api-plus/main/deploy/install.sh | sudo bash -s -- rollback 'v0.1.183+custom.003'
```

Upgrade to the latest release:

```bash
curl -sSL https://raw.githubusercontent.com/luohao830/sub2api-plus/main/deploy/install.sh | sudo bash -s -- upgrade
```

Remove the service and binary while preserving `/etc/sub2api`:

```bash
curl -sSL https://raw.githubusercontent.com/luohao830/sub2api-plus/main/deploy/install.sh | sudo bash -s -- uninstall --yes
```

Also remove `/etc/sub2api`. Back up required configuration first:

```bash
curl -sSL https://raw.githubusercontent.com/luohao830/sub2api-plus/main/deploy/install.sh | sudo bash -s -- uninstall --yes --purge
```

For a downloaded `install.sh`, invoke one operation at a time. For example:

```bash
sudo ./install.sh install --version 'v0.1.183+custom.004'
```
