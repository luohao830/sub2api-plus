...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	subscriptionQuotaResetMonitorRepository := repository.NewSubscriptionQuotaResetMonitorRepository(db)
	subscriptionQuotaResetMonitorService := service.ProvideSubscriptionQuotaResetMonitorService(subscriptionQuotaResetMonitorRepository, accountRepository, openAIQuotaService, subscriptionService, auditLogService, leaderLockCache)
	subscriptionQuotaResetMonitorHandler := admin.NewSubscriptionQuotaResetMonitorHandler(subscriptionQuotaResetMonitorService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, cnProviderHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, pluginHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, subscriptionQuotaResetMonitorHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, complianceHandler, auditLogHandler, ipAccessControlHandler, ollamaCloudUsageService, usageAlertService)
