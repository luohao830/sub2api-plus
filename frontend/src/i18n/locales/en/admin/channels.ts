export default {
    ...
    channelMonitorReset: {
      tab: 'Official Reset Link',
      title: 'Official Reset Link',
      description: 'Detect official OpenAI OAuth seven-day window resets and reset selected subscriptions. Observation is the default; subscriptions are never changed until automatic execution is enabled.',
      create: 'Add Link Rule',
      createTitle: 'Add Official Reset Link',
      editTitle: 'Edit Official Reset Link',
      name: 'Rule name',
      accounts: 'Source account IDs',
      selectAccounts: 'Select OpenAI OAuth parent accounts',
      accountsHint: 'OpenAI OAuth parent accounts only; separate multiple IDs with commas.',
      subscriptions: 'Target subscription IDs',
      selectSubscriptions: 'Select target user subscriptions',
      subscriptionsHint: 'Only these explicitly selected subscriptions are affected; separate multiple IDs with commas.',
      interval: 'Check interval (seconds)',
      threshold: 'Usage drop threshold (percentage points)',
      weekly: 'Weekly quota',
      daily: 'Daily quota',
      ...
      safetyHint: 'Keep automatic execution disabled while validating the rule history. Manual checks are always read-only.',
      status: 'Mode',
      ...
      check: 'Check now',
      history: 'History',
      empty: 'No link rules yet',
      noEvents: 'No events yet',
      createSuccess: 'Link rule created',
      updateSuccess: 'Link rule updated'
    },
